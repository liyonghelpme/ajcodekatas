...
Public Class SqlProcedure
    ...
    Public Sub New(ByVal store As SqlStore, ByVal text As String)
        Me.New(store, text, Nothing, Nothing)
    End Sub

    Public Sub New(ByVal store As SqlStore, ByVal text As String, ByVal map As Mapping, ByVal parmap As Mapping)
        mStore = store
        mText = text

        Dim conn As New SqlConnection(store.ConnectionString)
        Dim cmd As SqlCommand = New SqlCommand(text, conn)
        ...
        Try
            ...
            mParameters = New SqlParameter(cmd.Parameters.Count - 1) {}
            cmd.Parameters.CopyTo(mParameters, 0)
